...
void print_light(int light){
  ...
  if(light<=green){
  ...
  else if(light>green && light <=green+yellow){
    ...
    if(light==green+yellow+1){
      lcd.clear();
      lcd.setCursor(0, 0);
      lcd.print("red");
      lcd.setCursor(0, 1);
      lcd.print(num*-1+green+yellow+red);
      delay(1000);
    }
    lcd.setCursor(0, 0);
    lcd.print("red");
